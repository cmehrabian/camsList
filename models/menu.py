...
def _():
    ...
    response.menu+=[
        (CAT(),False,A('web2py',B('',_class='caret'),**{'_href': '#','_class':'dropdown-toggle','_data-toggle':'dropdown'}), [
                (T('My Sites'),False,URL('admin','default','site')),
                (CAT(I('',_class="icon-chevron-right"),SPAN(T('This App'))),False,URL('admin','default','design/%s' % app), [
                        (T('Controller'),False,
                ...
                (CAT(I('',_class="icon-chevron-right"),SPAN('web2py.com')),False,'http://www.web2py.com', [
                ...
                (CAT(I('',_class="icon-chevron-right"),SPAN(T('Documentation'))),False,'http://www.web2py.com/book', [
                ...
                (CAT(I('',_class="icon-chevron-right"),SPAN(T('Community'))),False, None, [
                ...
                (CAT(I('',_class="icon-chevron-right"),SPAN(T('Plugins'))),False,None, [
